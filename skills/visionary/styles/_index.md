...
- **claymorphism** — Inflated 3D blobs, thick drop shadow, pastel palette, high border-radius
- **skeuomorphism** — Texture overlays, material fidelity, realistic light sources and surfaces
- **flat** — Zero depth, zero shadow, strict full-saturation color, pure geometric forms
...
- **cottagecore** — Cream #FDFAF5, Playfair Display italic, sage green + dusty rose, zero shadows
- **dark-academia** — Warm dark #1A1510, EB Garamond, parchment text, candlelit gold accents
- **goblincore** — Earthy dark, IM Fell English, irregular border-radius, foraged-object references
- **seapunk** — Deep teal + coral, Courier New, aquatic shimmer, tide-in entrance animation
- **synthwave** — #0D0221 + hot pink #FF00A0 + cyan, Orbitron, perspective grid, horizon-rise
- **lofi-analog** — Warm cream, Special Elite typewriter font, film grain texture, vignette
- **webcore** — Windows 95 grey #C0C0C0, beveled borders, Times New Roman, zero border-radius
- **glitchcore** — RGB channel offset animation, IBM Plex Mono, near-black, pure R/G/B accents
- **dreamcore** — Washed-out yellow #F5F5C8, EB Garamond italic, vast empty space, slow dissolves
- **solarpunk** — Fresh pale green, art nouveau botanical references, solar gold, growth animations
- **post-internet-maximalism** — Deliberate chaos, mixed fonts, overlapping elements, every motion token
- **liminal-space** — Institutional off-white, Arial (anonymous), fluorescent light aesthetic, eerie void
...
- **art-deco** — Gold geometry, symmetry, stepped forms, luxury material references
- **art-nouveau** — Organic curves, botanical ornament, sinuous line, hand-lettered display
- **de-stijl** — Primary colors only, horizontal/vertical lines only, Mondrian grid
- **futurism** — Speed lines, motion blur, aggressive diagonal, machine worship
- **dada** — Anti-composition, collage chaos, absurdist juxtaposition, found typography
- **psychedelic** — Impossible colors, Op Art curves, hand-lettered acid fonts, visual overload
- **postmodern** — Irony, historical pastiche, Memphis pattern, deconstructed grid
- **new-wave-swiss-punk** — Broken grid, layered type, punk energy meets Swiss precision
- **memphis** — Squiggles, dots, primary + pastel, 1980s pattern exuberance
- **pop-art** — Ben-Day dots, primary colors, flat bold outlines, mass culture imagery
...
- **light-mode-sanctuary** — Pure white + warm off-white, soft shadow system, restorative
- **monochrome** — Single hue, tint/shade variation only, zero saturation mixing
- **high-contrast-a11y** — WCAG AAA, 7:1 minimum, bold type, maximum legibility
- **glass-dashboard** — Glassmorphism applied to data visualization and analytics surfaces
- **terminal-cli** — Monospace everything, green-on-black or amber-on-black, command-line heritage
- **wireframe-aesthetic** — Deliberate unfinished, dotted boxes, annotation typography, blueprint
- **brutalist-web** — Anti-aesthetic web, unstyled links, Times New Roman, no decoration
- **data-visualization** — Chart-first layout, D3-influenced color scales, information density
...
- **layered-type** — Multiple type layers at different opacities create depth without images
- **vertical-cjk** — Vertical text layout, CJK typography conventions, character-spaced columns
- **mono-aesthetic** — Monospace everywhere including body, terminal culture applied to product UI
- **handwritten-gestural** — Script fonts, gestural SVG paths, human imperfection as design value
...
- **neobank-consumer** — Coral/mint, rounded corners, friendly bold type, reward-driven motion
- **bloomberg-terminal** — Dense data, amber on black, monospace, function-pure information design
- **medtech-clinical** — White + teal, high contrast, accessible, zero visual noise
- **healthcare-wellness** — Soft blue + green, organic shapes, calm motion, empathetic tone
- **legaltech** — Serif type, conservative navy, table-heavy, document-first layout
- **govtech-civic** — Accessible first, flat color, sans-serif, universal legibility priority
- **edtech** — Bright accessible palette, illustrated characters, progress visualization, reward loops
- **proptech** — Photography-first, map integration, clean sans, property-card grid
- **agritech** — Earth tones, data dashboard, field-scale visualization, functional and grounded
- **saas-b2b-dashboard** — Sidebar nav, data density, action-first, muted professional palette
- **developer-tools** — Monospace code, dark mode default, token-based color, precision typography
- **ecommerce-retail** — Product photography dominant, conversion-optimized, trust signals
- **gaming** — High saturation, custom typeface, HUD overlay language, achievement system
...
- **trust-safety** — Blue/green system, shield iconography, social proof layout, calm pace
- **playful-joyful** — Illustrations, rounded everything, surprise interactions, non-serious tone
- **luxury-aspirational** — Gold/black/white, negative space, never explain, aspirational photography
- **brutalist-honesty** — No-UI UI, raw HTML aesthetic, no decoration, information without seduction
- **whimsical-storybook** — Illustrated worlds, character-driven, narrative UI, wonder-first
- **clinical-cold** — Pure white, precise grey, zero warmth, medical/laboratory reference
...
- **concrete-brutalist-material** — Concrete texture photography, raw grey, exposed aggregate
- **leather-craft** — Leather grain texture, stitching borders, warm brown palette
- **metal-chrome** — Specular gradient, brushed or polished metal simulation, reflective surfaces
- **fabric-textile** — Woven texture overlay, thread-like lines, fabric color vocabulary
- **wood-natural** — Wood grain photography, warm amber tones, organic imperfection
- **glass-crystal** — Prism refraction, specular light, crystal clarity as aesthetic value
- **stone-geological** — Rock texture, mineral color palette, geological cross-section reference
...
- **neon-dystopia** — Rain-soaked dark city, advertisement overload, corporate surveillance aesthetic
- **white-futurism** — Total white, precision curves, Jony Ive-era minimalism, clean tomorrow
...
- **south-asian-bollywood** — Maximum color, ornamental detail, celebration density, film poster energy
...
- **music-album-art** — Square format thinking, cover art composition rules applied to UI
- **photography-portfolio** — Photography-first, content IS the design, minimal chrome, gallery mode
- **sports-analytics** — Data visualization meets sports broadcast, team color systems, performance metric
- **zine-diy** — Photocopier aesthetic, hand-cut collage, risograph color limited palette
- **risograph-screen-print** — Ink overlap color mixing, grain texture, limited palette overlay
- **newspaper-broadsheet** — Column grid, justified type, headline hierarchy, ink-print reference
...
- **stone-mineral** — Crystal cross-section, mineral photography, geological palette precision
- **naive-outsider-art** — Deliberate un-training, child-art reference, authentic imperfection
- **reaction-diffusion** — Turing pattern animation, biological simulation as visual system
- **flow-field-vector** — Perlin noise vector field animation, flowing particle paths
- **data-physicalization** — Data rendered as physical objects, 3D chart, tangible information
- **uncanny-valley** — Deliberately almost-right, subtle wrongness, hyper-realism edge
- **soft-apocalypse** — Post-collapse warmth, community resilience, degraded-but-hopeful
- **hyper-comfort-hygge** — Maximum coziness, soft everything, comfort as UI value
- **awe-sublime** — Scale overwhelming, cosmic dread-wonder, Turner-painting digital
- **pharmaceutical-clean** — Pill-bottle aesthetics, clinical white, dosage typography, medical grade
- **legal-editorial** — Brief-format type, footnote system, dense citation layout, law review
- **agricultural-seed-catalog** — Vintage seed packet illustration, earthy functional, catalog grid
- **marine-nautical-chart** — Depth contour lines, compass rose, maritime blue, chart precision
...
- **Swiss Grid → Healthcare** — Precision + information hierarchy creates trust in clinical contexts
- **Bauhaus → SaaS** — Form-follows-function applied to software UI signals structured confidence
- **Y2K → Fintech startup** — Nostalgic chrome energy signals boldness without being a crypto bro

## Blocked Pairs (never transplant)
- **Psychedelic × Healthcare** — Visual overload in clinical contexts causes anxiety and trust failure
- **Anxious Energy × Finance** — Urgency design triggers panic selling and destroys user agency
- **Playful × Legal/GovTech** — Whimsy signals incompetence in high-stakes institutional contexts
